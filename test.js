...
const state = runSim([surtr, lumen, haruka, dummyEnemy], config);
...
console.log(`Total healing received by Surtr: ${(l.totalHealing + h.totalHealing).toFixed(0)} HP`);
console.log(`  Lumen:  ${l.totalHealing.toFixed(0)} HP`);
console.log(`  Haruka: ${h.totalHealing.toFixed(0)} HP`);
